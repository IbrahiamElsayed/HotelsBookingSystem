    ...
    public partial class Intial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ADMIN-USER-001", 0, "Cairo", "STATIC-CONCURRENCY-STAMP-001", "Egypt", "admin@site.com", true, "Admin User", false, null, "12345678901234", "ADMIN@SITE.COM", "ADMIN@SITE.COM", "AQAAAAIAAYagAAAAEIjJh6/LXD2Bg+3MJGc+CmiaE471FJWBEmlTQ/1OhqkFw0NIgG/beU7wkTfmnuQ/sQ==", null, false, "STATIC-SECURITY-STAMP-001", false, "admin@site.com" },
                    { "USER-USER-001", 0, "Alexandria", "STATIC-CONCURRENCY-STAMP-002", "Egypt", "user@site.com", true, "Normal User", false, null, "98765432109876", "USER@SITE.COM", "USER@SITE.COM", "AQAAAAIAAYagAAAAELyWnA3L8xp5Hrs6WnKF/jGfxKmtgxJyDrE/5cKoAAu34yOBFoySgbzAWe3pqdH3BA==", null, false, "STATIC-SECURITY-STAMP-002", false, "user@site.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ADMIN-ROLE-001", "ADMIN-USER-001" },
                    { "USER-ROLE-001", "USER-USER-001" }
                });
